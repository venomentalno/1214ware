...
implements MinecraftContext {
    ...
    public static void scissorRect(float x, float y, float width, double height) {
        ...
        RenderSystem.glScissor((int)((int)(x * (float)factor)), (int)((int)(((double)window.getScaledHeight() - height) * (double)factor)), (int)((int)((width - x) * (float)factor)), (int)((int)((height - (double)y) * (double)factor)));
    }
