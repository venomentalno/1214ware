...
extends Screen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RoundedUtils.drawGradientRound((float)(window.getScaledWidth() / (2) - (65)), (float)(window.getScaledHeight() / (2) - (80)), (float)130.0f, (float)160.0f, (float)8.0f, (Color)ClickGuiScreen.getC((int)(0)), (Color)ClickGuiScreen.getC((int)(250)), (Color)ClickGuiScreen.getC((int)(750)), (Color)ClickGuiScreen.getC((int)(1000)));
        RoundedUtils.drawRound((float)(window.getScaledWidth() / (2) - (65) + (2)), (float)(window.getScaledHeight() / (2) - (80) + (2)), (float)126.0f, (float)156.0f, (float)8.0f, (Color)new Color(17, 17, 17, 240));
        (FontRegistry.mnstb_16).drawCenteredGradientThemeString("NeoWare Client", (float)(window.getScaledWidth() / (2)), (float)(window.getScaledHeight() / (2) - (70)));
        (FontRegistry.mnstb_12).drawString("v" + (Client.VERSION_TYPE), (float)(window.getScaledWidth() / (2) + (32)), (float)(window.getScaledHeight() / (2) - (73)), new Color(180, 180, 180).getRGB());
